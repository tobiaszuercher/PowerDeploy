function Configure-Environment
{
    ...
    param(
        ...
        [Parameter(Position = 1)] [string]$subenv = '',
        [Parameter(Position = 2)] [string]$target_path = $powerdeploy.paths.project, 
        [Parameter(Position = 3)] [boolean]$delete_templates = $false
    )

    Write-Verbose "starting Configure-Environment"
    ...
    if (CheckWheterEnvironmentExist $environment)
    {
        ...
        {
            Transform-Template $template.Fullname $environment $subenv
