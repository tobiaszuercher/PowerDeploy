...
namespace PowerDeploy.Core.Cryptography
{
    /// <summary>
    ...
    /// Stolen from <see cref="https://github.com/jbubriski/Encryptamajig/blob/master/src/Encryptamajig/Encryptamajig/AesEncryptamajig.cs"/>
    /// </summary>
    public class AES
    {
